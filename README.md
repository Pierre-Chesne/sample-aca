...
Dans cet article, nous n'avons vu qu'une toute petite partie des fonctionnalités de "Azure Container Apps". Nous n'avons pas abordé les sujets comme : <br>
- Azure Function sur "Azure Container Apps" (article à venir)
